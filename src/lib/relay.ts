...
async function _buildRecoveredLocalMessage(
  ...
  try {
    const p: { v?: number; t?: string; mid?: string; isp?: string; ik?: string; vsp?: string; vk?: string; vd?: number; fsp?: string; fk?: string; fn?: string; fs?: number; ft?: string } = JSON.parse(decrypted);
