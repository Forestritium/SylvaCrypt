# Contributing to SylvaCrypt

Thank you for your interest in contributing to SylvaCrypt! This document outlines the process for reporting bugs, proposing features, and submitting code changes.
...
2. **Clone** your fork locally:
   ```bash
   git clone https://github.com/YOUR_USERNAME/SylvaCrypt.git
   cd SylvaCrypt
   ```
...
SylvaCrypt uses ESLint / Prettier for linting and formatting.

Key conventions:
- **2-space indentation** throughout.
- **No default exports** for utility functions — use named exports.
- **TypeScript strict mode** — no `any` or unchecked casts without a comment explaining why.
